    ...
    return (
        <div style={styles.container}>
            <div style={styles.header}>
                <h1 style={styles.title}>Laboratoire Dashboard</h1>
                <button onClick={handleLogout} style={styles.logoutBtn}>Logout</button>
            </div>
            <div style={styles.content}>
                <div style={styles.welcomeCard}>
                    <h2>Welcome, {user?.firstName} {user?.lastName}!</h2>
                    <p>Role: <strong>Laboratoire</strong></p>
                    <p>Email: {user?.email}</p>
                </div>
                <div style={styles.grid}>
                    <div style={styles.card}>
                        <h3>Pending Tests</h3>
                        <p>View tests awaiting processing</p>
                    </div>
                    <div style={styles.card}>
...
const styles: Record<string, React.CSSProperties> = {
    ...
    header: {
        ...
        padding: '1rem 2rem', backgroundColor: '#7c3aed', color: 'white'
    },
    title: { margin: 0, fontSize: '1.5rem' },
    logoutBtn: {
        padding: '0.5rem 1rem', backgroundColor: 'white', color: '#7c3aed',
